...
env = os.environ.copy()
gmt_path = r"E:\\app\\gmt6\bin"
env["PATH"] = f"{gmt_path};{env['PATH']}"

# os.system ('gmt begin Figure_2')
...
try:
    # 执行合并后的命令
    result = subprocess.run(gmtset_commands, shell=True, env=env, check=True, capture_output=True, text=True)
    print("命令执行成功，标准输出：")
    print(result.stdout)
...
os.system ('gmt basemap  -JX4.5i/1.35i -R0/1000/-240/0 -B0sew -X+0.75i -Y+1.0i  ')

# gmt plot compositional fields
os.system ('makecpt -Ctopo -T0/10/1 > color.cpt')
comp = "gmt plot     -A -L -Celmatpr.cpt  \n\
> -Z 1 \n 0   0 \n 1000   0 \n 1000 -20 \n 0 -20 \n 0   0 \n\
> -Z 2 \n 0 -20 \n 1000 -20 \n 1000 -40 \n 0 -40 \n 0 -25 \n\
> -Z 3 \n 0 -40 \n 1000 -40 \n 1000 -120 \n 0 -120 \n 0 -40 \n\
> -Z 4 \n 0 -120 \n 1000 -120 \n 1000 -240 \n 0 -240 \n 0 -120 \n\
...
# gmt plot gmt basemap for strength profile gmt plot
os.system ('gmt basemap   -JX0.75i/-1.35i -R0/800/0/120 -Ba500f100/a30f10nW  -X+5.25i >')

# Calculate strength profile
from Functions_Figure_2 import calcstrength
v=calcstrength('strength.dat')

# gmt plot strength values
os.system ('gmt plot strength1.dat   -R -JX -A -W0.5p,black >')
os.system ('gmt plot strength2.dat   -R -JX -A  -W0.5p,black,- >')

# Add text
gc = "gmt text   -JX8.5i/11i -R0/8.5/0/11 -X-6.00i -Y-1.0i -W  \n\
...
# Add line between 120 km depth on composition gmt plot and base of strength gmt plot
com="gmt plot    -W0.25p,red  \n\
5.255  1.670\n\
5.995  0.995\n\
END"; os.system (com)

# Add arrows for sides of composition gmt plot between 0 km and 120 km
com="gmt plot    -SVb0.015i/0.050i/0.050i -Gblack  \n\
...
# Add arrows for sides of composition gmt plot between 120 km and 240 km
com="gmt plot    -SVb0.015i/0.025i/0.025i -Gblack  \n\
...
# Add arrows for base of composition gmt plot between 100 km and 700 km
com="gmt plot    -SVb0.015i/0.025i/0.025i -Gblack  \n\
...
# Add text
gc = "gmt text -JX8.5i/4i -R0/8.5/7/11  \n\
